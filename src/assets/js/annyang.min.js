...
!(function (a, b) {
  ...
  var e,
    ...
    y = function (a, b, c) {
      g.push({ command: a, callback: b, originalPhrase: c }),
      ...
      for (var b, c = 0; c < a.length; c++) {
        ...
        for (var d = 0, e = g.length; d < e; d++) {
          ...
          if (i) {
            ...
            return (
              k &&
                (w("command matched: %c" + f.originalPhrase, l),
  ...
  return (c = {
    init: function (l) {
      ...
      e && e.abort && e.abort(),
        ...
        (e.onerror = function (a) {
          switch ((u(h.error, a), a.error)) {
            ...
            case "service-not-allowed":
              (f = !1),
                new Date().getTime() - i < 200
                  ? u(h.errorPermissionBlocked, a)
                  : u(h.errorPermissionDenied, a);
          }
        }),
        (e.onend = function () {
          if (((n = !1), u(h.end), f)) {
        ...
        (e.onresult = function (a) {
          ...
          for (
            var b = a.results[a.resultIndex], c = [], d = 0;
            d < b.length;
            d++
          )
            c[d] = b[d].transcript;
    ...
    addCallback: function (c, d, e) {
      ...
      "function" == typeof f &&
        h[c] !== b &&
        h[c].push({ callback: f, context: e || this });
    },
